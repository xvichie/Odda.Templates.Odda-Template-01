                    ...
                    <div className='flex flex-col lg:flex-row gap-8'>
                        ...
                        <div className='flex flex-col justify-between gap-4'>
                            <h4 className='text-gray-300 text-center text-sm lg:text-left'>
                                ძაან მაგარი იყო, იმენა ეგრე არსად არ გავრთობილვარ. მადლობა გიას კოტეჯებს, მიყვარხართ
                            </h4>
                            <div>
                                <h2 className='text-center font-semibold text-white lg:text-left'>ნიკა გვარამია</h2>
                                <h4 className='text-center text-primary text-xs lg:text-left'>კოტეჯების ბოზი</h4>
                            </div>
                        </div>
                    </div>
                    <div className='flex flex-col lg:flex-row gap-8'>
